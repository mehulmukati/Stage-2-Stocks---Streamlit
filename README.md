...
The applications require no external database or credentials.
...
The applications use local Parquet files under `data/` — no external database or credentials needed.
