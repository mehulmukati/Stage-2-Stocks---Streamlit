...
Quant-Portfolio-Maker is a sub-application of the main Streamlit screener. It provides two single-stock strategy
research workspaces:
...
execution timing and replay accounting continue to come from the repository's shared root modules. The deployed
